...
namespace Nanina
{
    public class BaseValues {
        ...
        public required uint dungeon_attack_timer_in_milliseconds;
        public required ulong time_for_allowing_another_fight_in_milliseconds;
        public required ulong time_limit_for_osu_code_verification_in_milliseconds;
        public required ulong time_for_allowing_another_claim_in_milliseconds;
        public required uint base_gacha_currency_amount;
        ...
        public required uint energy_regen_tick_in_seconds;
        ...
        public required uint user_xp_for_fights;
        public required uint user_xp_for_dungeons;
        public required uint maimai_score_expiration_in_milliseconds;
        ...
        public required uint base_activity_length_in_milliseconds;
        public required ulong continuous_fight_score_expiration_time_in_milliseconds;
    }
}
